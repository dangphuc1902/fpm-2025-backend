...
public class TransactionEventListener {
    ...
    public void handleTransactionCreated(TransactionCreatedEvent event) {
    	logger.info("[Local/Rabbit] TransactionCreatedEvent: transactionId={} walletId={} amount={}",
        ...
        try {
            ...
            logger.info("[Local/Rabbit] Wallet updated successfully for walletId={}", event.getWalletId());
        } catch (Exception e) {
        	logger.error("[Local/Rabbit Failed] TransactionCreatedEvent: walletId={}, error={}", event.getWalletId(), e.getMessage(), e);
        }
    }
}
