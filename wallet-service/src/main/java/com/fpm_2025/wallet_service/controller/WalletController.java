...
public class WalletController {
    ...
    public ResponseEntity<BaseResponse<List<WalletResponse>>> getUserWallets(
            @AuthenticationPrincipal Long userId) {
    ...
    public ResponseEntity<BaseResponse<List<WalletResponse>>> getActiveWallets(
            @AuthenticationPrincipal Long userId) {
    ...
    public ResponseEntity<BaseResponse<List<WalletResponse>>> getWalletsByType(
    ...
    public ResponseEntity<BaseResponse<WalletResponse>> getWalletById(
    ...
    public ResponseEntity<BaseResponse<BigDecimal>> getTotalBalance(
            @AuthenticationPrincipal Long userId) {
    ...
    public ResponseEntity<BaseResponse<Long>> getWalletCount(
            @AuthenticationPrincipal Long userId) {
